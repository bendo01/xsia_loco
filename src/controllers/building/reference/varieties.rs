...
use crate::models::building::reference::varieties::_entities::varieties as ReferenceModel;
use crate::models::building::reference::varieties::data_objects::DataObject as ReferenceDataObject;
use crate::models::building::reference::varieties::validation::varieties::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/building/reference/varieties")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "building.reference.varieties.index",
            )),
        )
        // .add(
        //     "/{id}",
