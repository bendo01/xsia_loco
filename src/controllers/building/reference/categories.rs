...
use crate::models::building::reference::categories::_entities::categories as ReferenceModel;
use crate::models::building::reference::categories::data_objects::DataObject as ReferenceDataObject;
use crate::models::building::reference::categories::validation::categories::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/building/reference/categories")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "building.reference.categories.index",
            )),
        )
        // .add(
        //     "/{id}",
