...
use crate::models::building::reference::room_types::_entities::room_types as ReferenceModel;
use crate::models::building::reference::room_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::building::reference::room_types::validation::room_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/building/reference/room_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "building.reference.room_types.index",
            )),
        )
        // .add(
        //     "/{id}",
