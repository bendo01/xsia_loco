...
use crate::models::building::reference::conditions::_entities::conditions as ReferenceModel;
use crate::models::building::reference::conditions::data_objects::DataObject as ReferenceDataObject;
use crate::models::building::reference::conditions::validation::conditions::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/building/reference/conditions")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "building.reference.conditions.index",
            )),
        )
        // .add(
        //     "/{id}",
