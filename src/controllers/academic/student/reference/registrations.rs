...
use crate::models::academic::student::reference::registrations::_entities::registrations as ReferenceModel;
use crate::models::academic::student::reference::registrations::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::student::reference::registrations::validation::registrations::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/student/reference/registrations")
        //.add("/", get(index))
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.student.reference.registrations.index",
            )),
        )
        // .add(
        //     "/{id}",
