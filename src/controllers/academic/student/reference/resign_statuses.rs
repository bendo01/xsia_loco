...
use crate::models::academic::student::reference::resign_statuses::_entities::resign_statuses as ReferenceModel;
use crate::models::academic::student::reference::resign_statuses::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::student::reference::resign_statuses::validation::resign_statuses::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/student/reference/resign_statuses")
        //.add("/", get(index))
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.student.reference.resign_statuses.index",
            )),
        )
        // .add(
        //     "/{id}",
