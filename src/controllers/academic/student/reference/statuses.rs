...
use crate::models::academic::student::reference::statuses::_entities::statuses as ReferenceModel;
use crate::models::academic::student::reference::statuses::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::student::reference::statuses::validation::statuses::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/student/reference/statuses")
        //.add("/", get(index))
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.student.reference.statuses.index",
            )),
        )
        // .add(
        //     "/{id}",
