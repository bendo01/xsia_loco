...
use crate::models::academic::lecturer::reference::ranks::_entities::ranks as ReferenceModel;
use crate::models::academic::lecturer::reference::ranks::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::lecturer::reference::ranks::validation::ranks::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/lecturer/reference/ranks")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.lecturer.reference.ranks.index",
            )),
        )
        // .add(
        //     "/{id}",
