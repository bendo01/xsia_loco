...
use crate::models::academic::lecturer::reference::statuses::_entities::statuses as ReferenceModel;
use crate::models::academic::lecturer::reference::statuses::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::lecturer::reference::statuses::validation::statuses::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/lecturer/reference/statuses")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.lecturer.reference.statuses.index",
            )),
        )
        // .add(
        //     "/{id}",
