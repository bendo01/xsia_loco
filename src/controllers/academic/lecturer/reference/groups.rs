...
use crate::models::academic::lecturer::reference::groups::_entities::groups as ReferenceModel;
use crate::models::academic::lecturer::reference::groups::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::lecturer::reference::groups::validation::groups::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/lecturer/reference/groups")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.lecturer.reference.groups.index",
            )),
        )
        // .add(
        //     "/{id}",
