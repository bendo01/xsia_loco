...
use crate::models::academic::lecturer::reference::contracts::_entities::contracts as ReferenceModel;
use crate::models::academic::lecturer::reference::contracts::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::lecturer::reference::contracts::validation::contracts::{
...
// #[debug_handler]
// pub async fn show(State(_ctx): State<AppContext>) -> Result<Response, Error> {
//     format::empty()
// }
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/lecturer/reference/contracts")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.lecturer.reference.contracts.index",
            )),
        )
        // .add(
        //     "/{id}",
