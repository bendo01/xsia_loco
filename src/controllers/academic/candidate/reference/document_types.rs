...
use crate::models::academic::candidate::reference::document_types::_entities::document_types as ReferenceModel;
use crate::models::academic::candidate::reference::document_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::candidate::reference::document_types::validation::document_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/candidate/reference/document_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.candidate.reference.document_types.index",
            )),
        )
        .add(
            "/{id}",
