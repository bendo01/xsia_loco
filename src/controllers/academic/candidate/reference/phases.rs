...
use crate::models::academic::candidate::reference::phases::_entities::phases as ReferenceModel;
use crate::models::academic::candidate::reference::phases::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::candidate::reference::phases::validation::phases::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/candidate/reference/phases")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.candidate.reference.phases.index",
            )),
        )
        .add(
            "/{id}",
