...
use crate::models::academic::survey::reference::bundle_categories::_entities::bundle_categories as ReferenceModel;
use crate::models::academic::survey::reference::bundle_categories::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::survey::reference::bundle_categories::validation::bundle_categories::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/survey/reference/bundle_categories")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.survey.reference.bundle_categories.index",
            )),
        )
        // .add(
        //     "/{id}",
