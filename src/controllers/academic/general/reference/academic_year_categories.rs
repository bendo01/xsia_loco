...
use crate::models::academic::general::reference::academic_year_categories::_entities::academic_year_categories as ReferenceModel;
use crate::models::academic::general::reference::academic_year_categories::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::general::reference::academic_year_categories::validation::academic_year_categories::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/general/reference/academic_year_categories")
        //.add("/", get(index))
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.general.reference.academic_year_categories.index",
            )),
        )
        .add(
            "/{id}",
