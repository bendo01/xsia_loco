...
use crate::models::academic::campaign::reference::attend_types::_entities::attend_types as ReferenceModel;
use crate::models::academic::campaign::reference::attend_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::attend_types::validation::attend_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/attend_types")
        .add("/list", get(list))
        .add(
            "/store",
