...
use crate::models::academic::campaign::reference::implementations::_entities::implementations as ReferenceModel;
use crate::models::academic::campaign::reference::implementations::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::implementations::validation::implementations::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/implementations")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.implementations.index",
            )),
        )
        // .add(
        //     "/{id}",
