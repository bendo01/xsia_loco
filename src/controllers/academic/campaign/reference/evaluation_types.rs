...
use crate::models::academic::campaign::reference::evaluation_types::_entities::evaluation_types as ReferenceModel;
use crate::models::academic::campaign::reference::evaluation_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::evaluation_types::validation::evaluation_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/evaluation_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.evaluation_types.index",
            )),
        )
        // .add(
        //     "/{id}",
