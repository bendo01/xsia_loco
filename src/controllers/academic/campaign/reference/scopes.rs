...
use crate::models::academic::campaign::reference::scopes::_entities::scopes as ReferenceModel;
use crate::models::academic::campaign::reference::scopes::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::scopes::validation::scopes::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/scopes")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.scopes.index",
            )),
        )
        // .add(
        //     "/{id}",
