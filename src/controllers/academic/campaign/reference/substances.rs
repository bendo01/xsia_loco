...
use crate::models::academic::campaign::reference::substances::_entities::substances as ReferenceModel;
use crate::models::academic::campaign::reference::substances::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::substances::validation::substances::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/substances")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.substances.index",
            )),
        )
        // .add(
        //     "/{id}",
