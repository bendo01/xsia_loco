...
use crate::models::academic::campaign::reference::encounter_types::_entities::encounter_types as ReferenceModel;
use crate::models::academic::campaign::reference::encounter_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::encounter_types::validation::encounter_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/encounter_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.encounter_types.index",
            )),
        )
        // .add(
        //     "/{id}",
