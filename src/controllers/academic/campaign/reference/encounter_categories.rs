...
use crate::models::academic::campaign::reference::encounter_categories::_entities::encounter_categories as ReferenceModel;
use crate::models::academic::campaign::reference::encounter_categories::data_objects::DataObject as ReferenceDataObject;
use crate::models::academic::campaign::reference::encounter_categories::validation::encounter_categories::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/academic/campaign/reference/encounter_categories")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "academic.campaign.reference.encounter_categories.index",
            )),
        )
        // .add(
        //     "/{id}",
