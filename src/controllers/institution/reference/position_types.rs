...
use crate::models::institution::reference::position_types::_entities::position_types as ReferenceModel;
use crate::models::institution::reference::position_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::institution::reference::position_types::validation::position_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/institution/reference/position_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "institution.reference.position_types.index",
            )),
        )
        // .add(
        //     "/{id}",
