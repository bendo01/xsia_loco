...
use crate::models::institution::reference::varieties::_entities::varieties as ReferenceModel;
use crate::models::institution::reference::varieties::data_objects::DataObject as ReferenceDataObject;
use crate::models::institution::reference::varieties::validation::varieties::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/institution/reference/varieties")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "institution.reference.varieties.index",
            )),
        )
        // .add(
        //     "/{id}",
