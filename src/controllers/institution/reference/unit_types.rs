...
use crate::models::institution::reference::unit_types::_entities::unit_types as ReferenceModel;
use crate::models::institution::reference::unit_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::institution::reference::unit_types::validation::unit_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/institution/reference/unit_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "institution.reference.unit_types.index",
            )),
        )
        // .add(
        //     "/{id}",
