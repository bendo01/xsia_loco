...
use crate::models::contact::reference::website_types::_entities::website_types as ReferenceModel;
use crate::models::contact::reference::website_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::contact::reference::website_types::validation::website_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/contact/reference/website_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "contact.reference.website_types.index",
            )),
        )
        // .add(
        //     "/{id}",
