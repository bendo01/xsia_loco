...
use crate::models::contact::reference::electronic_mail_types::_entities::electronic_mail_types as ReferenceModel;
use crate::models::contact::reference::electronic_mail_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::contact::reference::electronic_mail_types::validation::electronic_mail_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/contact/reference/electronic_mail_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "contact.reference.electronic_mail_types.index",
            )),
        )
        // .add(
        //     "/{id}",
