...
use crate::models::contact::reference::residence_types::_entities::residence_types as ReferenceModel;
use crate::models::contact::reference::residence_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::contact::reference::residence_types::validation::residence_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/contact/reference/residence_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "contact.reference.residence_types.index",
            )),
        )
        // .add(
        //     "/{id}",
