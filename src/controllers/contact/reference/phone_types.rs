...
use crate::models::contact::reference::phone_types::_entities::phone_types as ReferenceModel;
use crate::models::contact::reference::phone_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::contact::reference::phone_types::validation::phone_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/contact/reference/phone_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "contact.reference.phone_types.index",
            )),
        )
        // .add(
        //     "/{id}",
