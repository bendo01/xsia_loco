...
use crate::models::person::reference::hair_types::_entities::hair_types as ReferenceModel;
use crate::models::person::reference::hair_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::hair_types::validation::hair_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/hair_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.hair_types.index",
            )),
        )
        // .add(
        //     "/{id}",
