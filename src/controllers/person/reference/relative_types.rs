...
use crate::models::person::reference::relative_types::_entities::relative_types as ReferenceModel;
use crate::models::person::reference::relative_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::relative_types::validation::relative_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/relative_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.relative_types.index",
            )),
        )
        // .add(
        //     "/{id}",
