...
use crate::models::person::reference::blood_types::_entities::blood_types as ReferenceModel;
use crate::models::person::reference::blood_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::blood_types::validation::blood_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/blood_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.blood_types.index",
            )),
        )
        // .add(
        //     "/{id}",
