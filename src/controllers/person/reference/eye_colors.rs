...
use crate::models::person::reference::eye_colors::_entities::eye_colors as ReferenceModel;
use crate::models::person::reference::eye_colors::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::eye_colors::validation::eye_colors::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/eye_colors")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.eye_colors.index",
            )),
        )
        // .add(
        //     "/{id}",
