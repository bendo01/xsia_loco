...
use crate::models::person::reference::genders::_entities::genders as ReferenceModel;
use crate::models::person::reference::genders::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::genders::validation::genders::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/genders")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.genders.index",
            )),
        )
        // .add(
        //     "/{id}",
