...
use crate::models::person::reference::marital_statuses::_entities::marital_statuses as ReferenceModel;
use crate::models::person::reference::marital_statuses::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::marital_statuses::validation::marital_statuses::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/marital_statuses")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.marital_statuses.index",
            )),
        )
        // .add(
        //     "/{id}",
