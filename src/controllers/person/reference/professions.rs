...
use crate::models::person::reference::professions::_entities::professions as ReferenceModel;
use crate::models::person::reference::professions::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::professions::validation::professions::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/professions")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.professions.index",
            )),
        )
        // .add(
        //     "/{id}",
