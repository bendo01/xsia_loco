...
use crate::models::person::reference::occupations::_entities::occupations as ReferenceModel;
use crate::models::person::reference::occupations::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::occupations::validation::occupations::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/occupations")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.occupations.index",
            )),
        )
        // .add(
        //     "/{id}",
