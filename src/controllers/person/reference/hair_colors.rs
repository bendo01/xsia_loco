...
use crate::models::person::reference::hair_colors::_entities::hair_colors as ReferenceModel;
use crate::models::person::reference::hair_colors::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::hair_colors::validation::hair_colors::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/hair_colors")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.hair_colors.index",
            )),
        )
        // .add(
        //     "/{id}",
