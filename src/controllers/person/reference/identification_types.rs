...
use crate::models::person::reference::identification_types::_entities::identification_types as ReferenceModel;
use crate::models::person::reference::identification_types::data_objects::DataObject as ReferenceDataObject;
use crate::models::person::reference::identification_types::validation::identification_types::{
...
pub fn routes(ctx: &AppContext) -> Routes {
    Routes::new()
        .prefix("api/person/reference/identification_types")
        .add("/list", get(list))
        .add(
            "/store",
            post(store).layer(AuthorizedLayer::new(
                ctx.clone(),
                "person.reference.identification_types.index",
            )),
        )
        // .add(
        //     "/{id}",
