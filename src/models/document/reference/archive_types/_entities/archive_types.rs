...
#[sea_orm(
    schema_name = "document_reference",
    table_name = "archive_types"
)]
pub struct Model {
...
impl RelationTrait for Relation {
    fn def(&self) -> RelationDef {
        match self {
            Self::Archives => Entity::has_many(DocumentTransactionArchive::Entity)
                .from(Column::Id)
                .to(DocumentTransactionArchive::Column::ArchiveTypeId)
                .into(),
        }
    }
}
