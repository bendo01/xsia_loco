        ...
        match self {
            Self::Submissions => {
                Entity::has_many(AcademicStudentFinalAssignmentTransactionSubmission::Entity)
                    .from(Column::Id)
                    .to(AcademicStudentFinalAssignmentTransactionSubmission::Column::ApprovalTypeId)
                    .into()
            }
            ...
            .from(Column::Id)
            .to(AcademicStudentFinalAssignmentTransactionPrerequisite::Column::ApprovalTypeId)
            .into(),
        }
    }
}
