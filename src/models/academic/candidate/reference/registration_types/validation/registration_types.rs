...
impl ModelValidator {
    ...
    pub fn from_model(model: &ReferenceModel::Model) -> Self {
        Self {
            ...
            student_registration_id: model.student_registration_id,
            unit_id: model.unit_id,
            institution_id: model.institution_id,
            registration_category_id: model.registration_category_id,
        }
    }
    ...
    pub fn from_active_model(model: &ReferenceModel::ActiveModel) -> Self {
        Self {
            ...
            student_registration_id: model.student_registration_id.as_ref().to_owned(),
            unit_id: model.unit_id.as_ref().to_owned(),
            institution_id: model.institution_id.as_ref().to_owned(),
            registration_category_id: model.registration_category_id.as_ref().to_owned(),
        }
    }
}
