...
use crate::models::feeder::master::matakuliah::{
    _entities::matakuliah, feeder_model::ModelInputDetailMatakuliah,
};
...
impl Worker {
    async fn upsert_record(ctx: &AppContext, record: &ModelInputDetailMatakuliah) -> Result<String> {
