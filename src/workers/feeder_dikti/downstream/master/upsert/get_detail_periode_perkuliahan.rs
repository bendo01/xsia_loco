...
use crate::models::feeder::master::periode_perkuliahan::{
    _entities::periode_perkuliahan, feeder_model::ModelInputPeriodePerkuliahan,
};
...
pub struct WorkerArgs {
    pub records: Vec<ModelInputPeriodePerkuliahan>,
}
...
impl BackgroundWorker<WorkerArgs> for Worker {
    ...
    fn class_name() -> String {
        "GetDetailPeriodePerkuliahan".to_string()
    }
    ...
    /// 1. Converts each `ModelInputPeriodePerkuliahan` to database entity
    ...
    async fn perform(&self, args: WorkerArgs) -> Result<()> {
        println!("=================GetDetailPeriodePerkuliahan=======================");
...
impl Worker {
    ...
    async fn upsert_record(ctx: &AppContext, record: &ModelInputPeriodePerkuliahan) -> Result<String> {
        // Start transaction
        ...
        let action = if let Some(existing_record) = existing {
            ...
            active.jumlah_pendaftar_ikut_seleksi = Set(record.jumlah_pendaftar_ikut_seleksi.clone());
            active.jumlah_pendaftar_lulus_seleksi = Set(record.jumlah_pendaftar_lulus_seleksi.clone());
            active.jumlah_daftar_ulang = Set(record.jumlah_daftar_ulang.clone());
            active.jumlah_mengundurkan_diri = Set(record.jumlah_mengundurkan_diri.clone());
            active.jumlah_minggu_pertemuan = Set(record.jumlah_minggu_pertemuan.clone());
            ...
            let new_record = periode_perkuliahan::ActiveModel {
                ...
                jumlah_pendaftar_ikut_seleksi: Set(record.jumlah_pendaftar_ikut_seleksi.clone()),
                jumlah_pendaftar_lulus_seleksi: Set(record.jumlah_pendaftar_lulus_seleksi.clone()),
                jumlah_daftar_ulang: Set(record.jumlah_daftar_ulang.clone()),
                jumlah_mengundurkan_diri: Set(record.jumlah_mengundurkan_diri.clone()),
                jumlah_minggu_pertemuan: Set(record.jumlah_minggu_pertemuan.clone()),
