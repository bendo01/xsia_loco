...
impl Hooks for App {
    ...
    async fn connect_workers(ctx: &AppContext, queue: &Queue) -> Result<()> {
        ...
        queue.register(crate::workers::feeder_dikti::downstream::master::upsert::get_list_kelas_kuliah::Worker::build(ctx)).await?;
        queue.register(crate::workers::feeder_dikti::downstream::master::upsert::get_list_kurikulum::Worker::build(ctx)).await?;
        queue.register(crate::workers::feeder_dikti::downstream::master::upsert::get_detail_kurikulum::Worker::build(ctx)).await?;
    ...
    fn register_tasks(tasks: &mut Tasks) {
        ...
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_list_kelas_kuliah::EstimateListKelasKuliah,
        );
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_list_kurikulum::EstimateKurikulum,
        );
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_detail_kurikulum::EstimateDetailKurikulum,
        );
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_list_mahasiswa_lulus_do::EstimateListMahasiswaLulusDO,
        );
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_detail_mahasiswa_lulus_do::EstimateDetailMahasiswaLulusDO,
        );
        tasks.register(
        ...
        tasks.register(
            tasks::feeder_dikti::downstream::estimasi::master::get_detail_nilai_perkuliahan_kelas::EstimateDetailNilaiPerkuliahanKelas,
        );
        tasks.register(
        ...
        tasks.register(tasks::tui::cnn_burn_forecast::ConvolutionalNeuralNetworkBurnForecast);
        tasks.register(tasks::tui::cnn_burn_training::ConvolutionalNeuralNetworkBurnTraining);
