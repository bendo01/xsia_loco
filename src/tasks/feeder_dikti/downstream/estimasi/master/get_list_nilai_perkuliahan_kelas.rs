...
const TASK_NAME: &str = "EstimateNilaiPerkuliahanKelas";
...
pub struct EstimateNilaiPerkuliahanKelas;

impl EstimateNilaiPerkuliahanKelas {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::nilai_perkuliahan_kelas::feeder_model::ModelInput as FeederModel;
        ...
        let worker_args =
            crate::workers::feeder_dikti::downstream::master::upsert::get_list_nilai_perkuliahan_kelas::WorkerArgs {
                records,
            };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_list_nilai_perkuliahan_kelas::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
#[async_trait]
impl Task for EstimateNilaiPerkuliahanKelas {
