...
impl EstimateDetailNilaiPerkuliahanKelas {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::detail_nilai_perkuliahan_kelas::feeder_model::ModelInput as FeederModel;
        ...
        let worker_args =
            crate::workers::feeder_dikti::downstream::master::upsert::get_detail_nilai_perkuliahan_kelas::WorkerArgs {
                records,
            };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_detail_nilai_perkuliahan_kelas::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
impl Task for EstimateDetailNilaiPerkuliahanKelas {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            ...
            detail: "Fetch and process Detail Nilai Perkuliahan Kelas data from Feeder Dikti".to_string(),
        }
    }
