...
const TASK_NAME: &str = "EstimateDosen";
const API_ACTION: &str = "GetListDosen";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000; // Records per API request page
const DEFAULT_ORDER: &str = "nama_dosen ASC"; // Sort order for API results
...
impl EstimateDosen {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::dosen::feeder_model::ModelInput as FeederModel;
        ...
        let worker_args =
            crate::workers::feeder_dikti::downstream::master::upsert::get_list_dosen::WorkerArgs {
                records,
            };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_list_dosen::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
#[async_trait]
impl Task for EstimateDosen {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            name: TASK_NAME.to_string(),
            detail: "Fetch and process List Dosen data from Feeder Dikti".to_string(),
        }
    }
