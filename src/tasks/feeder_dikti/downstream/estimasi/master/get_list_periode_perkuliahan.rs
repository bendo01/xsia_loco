...
const TASK_NAME: &str = "EstimateGetListPeriodePerkuliahan";
...
pub struct EstimateGetListPeriodePerkuliahan;

impl EstimateGetListPeriodePerkuliahan {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::periode_perkuliahan::feeder_model::ModelInputListPeriodePerkuliahan as FeederModel;
        ...
        let worker_args = crate::workers::feeder_dikti::downstream::master::upsert::get_list_periode_perkuliahan::WorkerArgs {
            records,
        };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_list_periode_perkuliahan::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
#[async_trait]
impl Task for EstimateGetListPeriodePerkuliahan {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            name: TASK_NAME.to_string(),
            detail: "Fetch and process GetListPeriodePerkuliahan data from Feeder Dikti".to_string(),
        }
    }
