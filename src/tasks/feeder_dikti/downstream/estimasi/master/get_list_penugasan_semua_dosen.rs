...
impl EstimateListPenugasanSemuaDosen {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::penugasan_dosen::feeder_model::ModelInputListPenugasanSemuaDosen as FeederModel;
        ...
        let worker_args = crate::workers::feeder_dikti::downstream::master::upsert::get_list_penugasan_semua_dosen::WorkerArgs {
            records,
        };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_list_penugasan_semua_dosen::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
impl Task for EstimateListPenugasanSemuaDosen {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            ...
            detail: "Fetch and process List Penugasan Semua Dosen data from Feeder Dikti".to_string(),
        }
    }
