...
impl EstimateDetailPeriodePerkuliahan {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::periode_perkuliahan::feeder_model::ModelInputDetailPeriodePerkuliahan as FeederModel;
...
impl Task for EstimateDetailPeriodePerkuliahan {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            ...
            detail: "Fetch and process Detail Periode Perkuliahan data from Feeder Dikti"
                .to_string(),
        }
    }
