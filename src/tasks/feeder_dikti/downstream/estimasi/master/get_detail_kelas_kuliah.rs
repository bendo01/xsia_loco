...
const TASK_NAME: &str = "EstimateGetDetailKelasKuliah";
...
pub struct EstimateGetDetailKelasKuliah;

impl EstimateGetDetailKelasKuliah {
    ...
    async fn enqueue_worker(
        ...
        use crate::models::feeder::master::kelas_kuliah::feeder_model::KelasKuliah as FeederModel;
        ...
        let worker_args = crate::workers::feeder_dikti::downstream::master::upsert::get_detail_kelas_kuliah::WorkerArgs {
            records,
        };

        match crate::workers::feeder_dikti::downstream::master::upsert::get_detail_kelas_kuliah::Worker::perform_later(app_context, worker_args).await {
            Ok(_) => {
...
#[async_trait]
impl Task for EstimateGetDetailKelasKuliah {
    fn task(&self) -> TaskInfo {
        TaskInfo {
            name: TASK_NAME.to_string(),
            detail: "Fetch and process GetDetailKelasKuliah data from Feeder Dikti".to_string(),
        }
    }
